...
- 툴바 버튼의 resting 상태를 CodePen liquid glass 참고 스타일에 맞춰 더 투명하게 정리했습니다.
- 하단 툴바 툴팁, 즐겨찾기 설정, 모바일 선택 문맥, table builder 흐름을 개선했습니다.
- README 메인 UI preview와 palette overflow 샘플 이미지를 최신 UI 기준으로 갱신했습니다.

### v0.6.20

- README 첫 번째 소개 이미지를 실제 UI/UX 흐름을 보여주는 밝은 모던 목업 스타일로 교체했습니다.

### v0.6.19

- 중앙/기본 툴바 아이콘에 마우스를 올렸을 때 툴팁이 두 번째 줄 favorite 아이콘 뒤로 깔리지 않도록 레이어 순서를 보정했습니다.
...
- Add favorite command: 드롭다운에서 툴바에 고정할 명령을 추가합니다.
